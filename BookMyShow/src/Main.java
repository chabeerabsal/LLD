...
public class Main {
    ...
    private void createTheatr() {
        ...
        Shows inoxMorningShow = createShows(1, inoxTheatre.getScreen().get(0), avengerMovie);
        Shows inoxEveningShow = createShows(2, inoxTheatre.getScreen().get(0), baahubali);
        ...
        pvrTheatre.setCity(City.CHENNAI);
        List<Shows> pvrShows = new ArrayList<>();
        Shows pvrMorningShow = createShows(3, pvrTheatre.getScreen().get(0), avengerMovie);
        Shows pvrEveningShow = createShows(4, pvrTheatre.getScreen().get(0), baahubali);
    ...
    private Shows createShows(int showId, Screen screen, Movie movie) {

        Shows show = new Shows();
        show.setShowsid(showId);
